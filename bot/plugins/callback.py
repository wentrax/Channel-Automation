...
async def cb_handler(client: Robot, message: CallbackQuery):
    if message.reply_to_message.from_user.id == message.from_user.id:
        ...
        if message.data.startswith("next"):
            ...
            ident, index, keyword = message.data.split("_")
        ...
        elif message.data.startswith("back"):
            await message.answer()
            ident, index, keyword = message.data.split("_")
            data = BUTTONS[keyword] 
        ...
        elif message.data == "pages":
            await message.answer()

    else:
        await message.answer("Thats not for you!!",show_alert=True)
