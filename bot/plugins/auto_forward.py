...
async def forward(bot, update):
    try:      
        await bot.copy_message(
            ...
            caption=f"**{update.caption}**".replace("@Latest_Movies_Reborn", " ").replace ("🔥 Fɪʀꜱᴛ Oɴ Tᴇʟᴇɢʀᴀᴍ 🔥", " ").replace("@BollyWeeBHolly", " ").replace("@JESSEVERSE", " ").replace("@Theprofffesorr", " ").replace("🔥 Join Us On Telegram 🔥", " ").replace("@File_Movies_Uploaded", " "),          
